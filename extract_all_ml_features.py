...
This script runs both text and financial feature extractions to create comprehensive ML feature tables.

Usage:
    python extract_all_ml_features.py --mode [training|prediction] --setup-list [file]
"""
...
from extract_text_features import TextFeaturesExtractor
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Extract all ML features')
